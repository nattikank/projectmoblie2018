...
$sql = 'select * from postphoto inner join user on postphoto.user_id=user.id where user_id ="'.$_POST['id'].'"&& type="'.$_POST['type'].'"';

$front = 'select Count(*) from postphoto where user_id="'.$_POST['id'].'"&& type="'.$_POST['type'].'"';
